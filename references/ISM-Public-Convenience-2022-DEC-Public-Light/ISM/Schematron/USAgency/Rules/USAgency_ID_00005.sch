...
<!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:ism="urn:us:gov:ic:ism" id="USAgency-ID-00005">
    ...
    <sch:rule id="USAgency-ID-00005-R1" context="*[@uias:dutyOrganization]">
        <sch:assert test="not(./@uias:dutyOrganization='USA.OPIC')" flag="warning" role="warning">
            [USAgency-ID-00005][Warning] "USA.OPIC" has been replaced by "USA.DFC". 
            Please contact the organization for information about when this value should be updated.
        </sch:assert>
    </sch:rule>
